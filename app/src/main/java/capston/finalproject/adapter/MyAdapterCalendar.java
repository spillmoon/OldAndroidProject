 ...
 */
public class MyAdapterCalendar extends BaseAdapter {
     ...
     */
    public MyAdapterCalendar(Context context, int textResource, ArrayList<DayInfo> dayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mDayList.get(position).getFlag() == 1) {
            dayViewHolder.tvDay.setBackground(new ColorDrawable(0xFF14C1C7));
        }
        if (day != null) {
